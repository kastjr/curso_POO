...
const post1: Postagem = new Postagem(1, 'comeca a copa', 3000)
const post2: Postagem = new Postagem(2, 'Brasil na final', 5000)
const post3: Postagem = new Postagem(3, 'Brasil campeao', 10000)
